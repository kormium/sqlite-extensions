...
import csqlite_decimal.kormium_register_sqlite_decimal
...
public actual object SqliteDecimal : SqliteExtension {

    actual override val name: String = "sqlite-decimal"
    ...
    override fun beforeOpen(registration: SqliteRegistrationScope) {
        ...
        check(kormium_register_sqlite_decimal() == 0) {
            "sqlite3_auto_extension(sqlite3_decimal_init) failed"
        }
    }
