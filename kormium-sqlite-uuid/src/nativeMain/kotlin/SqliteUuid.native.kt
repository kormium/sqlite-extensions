...
import csqlite_uuid.kormium_register_sqlite_uuid
...
public actual object SqliteUuid : SqliteExtension {

    actual override val name: String = "sqlite-uuid"
    ...
    override fun beforeOpen(registration: SqliteRegistrationScope) {
        ...
        check(kormium_register_sqlite_uuid() == 0) {
            "sqlite3_auto_extension(sqlite3_uuid_init) failed"
        }
    }
